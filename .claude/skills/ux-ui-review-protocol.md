...
>
> Metadata originale — name: ux-ui-review-protocol. Descrizione: skill procedurale review UX/UI — 5 step ancorati alla rubrica anti-soggettività (Nielsen 10 + dimensioni UI 6 + flusso 5). Capability opt-in v2.18, PATTERN §3 UX/UI Review.
...
La review orchestra le skill condivise già create: [screenshot-capture-protocol](mdc:.cursor/skills/screenshot-capture-protocol/SKILL.md) (Step 1,
cattura via Playwright — TSK-042/US-031), [design-tokens-extraction](mdc:.cursor/skills/design-tokens-extraction/SKILL.md) + [design-system-conformance-check](mdc:.cursor/skills/design-system-conformance-check/SKILL.md)
...
**Azione** — invoca `extract_design_tokens(target)` (skill [design-tokens-extraction](mdc:.cursor/skills/design-tokens-extraction/SKILL.md)) seguito da
...
(prodotto dal gate US-074 / [ux-ui-design-protocol](mdc:.cursor/skills/ux-ui-design-protocol/SKILL.md) Step 2-bis). Se assente → documentare
